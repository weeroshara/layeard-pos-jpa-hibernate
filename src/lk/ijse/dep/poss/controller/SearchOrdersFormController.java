...
public class SearchOrdersFormController {
    ...
    private void navigateToHome(MouseEvent event) throws IOException {
        URL resource = this.getClass().getResource("/lk/ijse/dep/poss/view/MainForm.fxml");
    ...
    public void tblOrders_OnMouseClicked(MouseEvent mouseEvent) throws IOException {
        ...
        if (mouseEvent.getClickCount() == 2) {
            FXMLLoader fxmlLoader = new FXMLLoader(this.getClass().getResource("/lk/ijse/dep/poss/view/PlaceOrderForm.fxml"));
